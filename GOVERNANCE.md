...
|---|---|
| `APPROVE XAB SCAFFOLD` | Push initial Next.js scaffold to XAB main |
...
| `APPROVE EMBEDDING PROVIDER: [name]` | Select embedding model and begin ingestion |
...
- `receipt_required` — every completed action logged to `14_Receipts`
...
- Secret or env var changes
- Domain / DNS changes
- Paid resource activation
- Autonomous trading or payments
...
- Security, authorization, tenant isolation, data integrity, rollback, financial model governance: **must score 100 individually**
